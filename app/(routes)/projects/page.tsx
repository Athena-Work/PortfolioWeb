...
export default function ProjectPage() {
  return (
    <main className="relative w-full pt-27">
      ...
      <section className="sticky top-0 w-full bg-white h-auto ">
        <div className="w-full h-[500px] rounded-4xl overflow-hidden">
          <Image
      ...
      <section className="sticky top-0 w-full bg-white h-max">
        <div>
          <Image
        ...
        <div className="flex flex-col gap-5  h-[350] md:h-[400px]">
          <p className="text-5xl md:text-6xl lg:text-7xl font-[800] mt-5">
            TaskFlow
          </p>
          <p className="text-xl md:text-3xl md:w-[60%] text-secondary100">
